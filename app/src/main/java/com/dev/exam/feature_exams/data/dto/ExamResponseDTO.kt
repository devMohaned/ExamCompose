...
data class ExamResponseDTO(
    val id: Int, val title: String, val descreption: String, val creatorId: String = ""
) {
    fun toExamEntity(): ExamEntity {
        return ExamEntity(id = id, title =title, description = descreption, creatorId = creatorId)
    }
}